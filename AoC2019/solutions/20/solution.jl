...
function t1()
    #Loading maze
    maze, width, height = load_maze(input_path)
    ...
    to_visit = PriorityQueue{PathState, Int64}([(PathState(start, 0), 0)])
    ...
    while !isempty(to_visit)
        ...
        for direction in 1:4
            ...
            to_visit[PathState(new_pos, current_state.path_length + 1)] = current_state.path_length + 1

...
Monkey::T_int run(std::vector<Monkey> monkeys, int total_rounds, bool level_drop){
...
void solution(){
    ...
    for (int i = 0; i < data.size();){
        ...
        m.divisor = div;
        m.test = [div](Monkey::T_int value) -> bool {
            return value % div == 0;
        };
        ...
        auto func = op_tokens[1][0] == '*' ?
                [](Monkey::T_int i1, Monkey::T_int i2){return i1 * i2;} :
                [](Monkey::T_int i1, Monkey::T_int i2){return i1 + i2;};


        if (op_tokens[2] == "old"){
            m.operation = [func](Monkey::T_int old){
                return func(old, old);
            };
        }
        else {
